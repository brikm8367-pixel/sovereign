...
export function InviteManagerDialog({ open, onOpenChange }: Props) {
  ...
  const generate = async () => {
    ...
    try {
      console.log('[InviteManagerDialog] Invoking Supabase function: create-manager-invite');
      ...
      console.error('Failed to create manager invitation. Full error details:', err);
